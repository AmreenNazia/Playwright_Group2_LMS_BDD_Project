...
const bddFileMeta = {
  ...
  "Validate login with invalid credentials|Example #1": {"pickleLocation":"24:1"},
  "Validate login credentials with null Adminname|Example #1": {"pickleLocation":"34:1"},
  "Validate login credentials with null password|Example #1": {"pickleLocation":"42:1"},
  "Validate login credentials with null userName and password|Example #1": {"pickleLocation":"50:1"},
};