...
const bddFileMeta = {
  "Validate login with valid credentials|Example #1": {"pickleLocation":"13:1"},
  "Validate login with invalid credentials|Example #1": {"pickleLocation":"22:1"},
  "Validate login credentials with null Adminname|Example #1": {"pickleLocation":"32:1"},
  "Validate login credentials with null password|Example #1": {"pickleLocation":"40:1"},
  "Validate login credentials with null userName and password|Example #1": {"pickleLocation":"48:1"},
};