...
const bddFileMeta = {
  "Validate login with valid credentials|Example #1": {"pickleLocation":"14:1"},
  "Validate login with invalid credentials|Example #1": {"pickleLocation":"23:1"},
  "Validate login credentials with null Adminname|Example #1": {"pickleLocation":"33:1"},
  "Validate login credentials with null password|Example #1": {"pickleLocation":"41:1"},
  "Validate login credentials with null userName and password|Example #1": {"pickleLocation":"49:1"},
};