...
const bddFileMeta = {
  "Verify Admin is able to land on login page": {"pickleLocation":"7:1"},
  "Verify Admin is able to land on home page with invalid URL": {"pickleLocation":"11:1"},
  "Verify for broken link": {"pickleLocation":"16:1"},
  "Verify the text spelling in the page": {"pickleLocation":"20:1"},
  "Verify application name": {"pickleLocation":"24:1"},
  "Validate sign in content": {"pickleLocation":"33:1"},
  "Verify text field is present": {"pickleLocation":"38:1"},
  "Verify text on the first text field": {"pickleLocation":"43:1"},
  "Verify text on the second text field": {"pickleLocation":"47:1"},
  "verify Login button is present": {"pickleLocation":"56:1"},
};