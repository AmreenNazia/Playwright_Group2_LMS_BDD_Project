...
test.describe.only("Navigation", () => {
  ...
  test("Verify that Admin is able to navigate to Program module", { tag: ["@only"] }, async ({ Given, When, Then }) => {
...
const bddFileMeta = {
  "Verify that Admin is able to navigate to Program module": {"pickleLocation":"7:5","tags":["@only"]},
};